...
//		if (grade == 1) {
//			System.out.println("정가가 12000원인 일반 등급의 할인도는 " + (cost - (cost / 20)) + "원 입니다.");
//		} else if (grade == 2) {
//			System.out.println("정가가 12000원인 브론즈 등급의 할인도는 " + (cost - (cost / 10)) + "원 입니다.");
//		} else if (grade == 3) {
//			System.out.println("정가가 12000원인 실버 등급의 할인도는 " + (cost - (cost / 100 * 15)) + "원 입니다.");
//		} else if (grade == 4) {
//			System.out.println("정가가 12000원인 골드 등급의 할인도는 " + (cost - (cost / 5)) + "원 입니다.");
//		} else {
//			System.out.println("정가가 12000원인 플래티넘 등급의 할인도는 " + (cost - (cost / 1000 * 27)) + "원 입니다.");
//		}
